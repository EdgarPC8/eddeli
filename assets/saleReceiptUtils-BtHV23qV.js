import{v as O}from"./index-CswUUby4.js";import{f as S}from"./functions-Blm8d6hr.js";const D=["ticket80","ticket55"];function z(t){return D.includes(t)}function M(t){return t==="ticket55"?55:t==="ticket80"?80:null}function F(t){return t==="ticket55"?2:t==="ticket80"?3:0}function K(t){return t==="ticket55"?[55,200]:t==="ticket80"?[80,200]:null}function L(t){if(t==="a4")return{isTicket:!1,previewWidth:null,maxWidth:720,pad:3,baseFont:15,businessName:22,businessDesc:13,docTitle:17,meta:13,date:18,customer:16,total:17,footer:12,signature:14,tableProductWidth:"auto",productColPct:null,print:null};const e=t==="ticket55";return{isTicket:!0,narrow:e,previewWidth:e?200:280,maxWidth:e?200:280,pad:e?.75:1,baseFont:e?12:14,businessName:e?14:17,businessDesc:e?10:12,docTitle:e?13:15,meta:e?10:12,date:e?13:16,customer:e?12:14,total:e?13:15,footer:e?10:11,signature:e?11:13,tableProductWidth:e?"38%":"42%",productColPct:e?{product:"38%",cant:"14%",pu:"24%",total:"24%"}:{product:"40%",cant:"12%",pu:"24%",total:"24%"},print:e?{fs:"11px",title:14,desc:10,docTitle:13,meta:10,date:13,customer:12,num:10,totalBold:13,notes:10,footer:10,signature:11,padH:"1mm"}:{fs:"13px",title:17,desc:12,docTitle:15,meta:12,date:16,customer:14,num:12,totalBold:15,notes:11,footer:11,signature:13,padH:"2mm"}}}const P="[CAJA_POS]",I="[CONTADO]",q="[CREDITO]";function Q({baseNote:t,saleType:e}){const n=e==="credito"?q:I,i=String(t).replace(/\[CAJA_POS\]/g,"").replace(/\[CONTADO\]/g,"").replace(/\[CREDITO\]/g,"").replace(/\s+/g," ").trim();return`${P} ${n} ${i}`.trim()}function j(t){if(!t)return"—";const e=String(t.notes||""),n=t.customer,i=String((n==null?void 0:n.name)||"").trim();if(!e.includes(P))return i||"—";const l=e.toLowerCase();return l.includes("mostrador")||l.includes("consumidor final")||l.includes("sin datos de cliente")?"Consumidor Final":i||"—"}function X(t){return String((t==null?void 0:t.notes)||"").includes(P)}function Z(t){return t.find(e=>{const n=String(e.name||"").toLowerCase();return n.includes("consumidor")||n.includes("final")})??null}function W(t,{format:e="a4"}={}){if(!t)return;const n=z(e),i=M(e)??80,l=F(e),o=n?`
...
<body>${d}</body>
        ...
        `,m.head.appendChild(f)}p.focus(),p.print()}finally{window.setTimeout(()=>c.remove(),1500)}};window.setTimeout(r,350)}const g=t=>Number(Number(t||0).toFixed(2)),T=t=>Number(Number(t||0).toFixed(3)),B={factura:"Factura",nota_venta:"Nota de venta",documento:"Comprobante",consumidor_final:"Consumidor final"},tt=[{value:"factura",label:"Factura"},{value:"nota_venta",label:"Nota de venta"},{value:"documento",label:"Comprobante"},{value:"consumidor_final",label:"Consumidor final"}];function A(t){return B[t]||t||"—"}function N(t){switch(t){case"factura":return"FACTURA";case"nota_venta":return"NOTA DE VENTA";case"consumidor_final":return"CONSUMIDOR FINAL";default:return"COMPROBANTE DE VENTA"}}function et(t,e){if(!t)return null;const n=e||t.documentType||"documento",i=t._customerRaw||{};if(n==="consumidor_final")return{...t,documentType:n,documentTypeLabel:A(n),documentTitle:N(n),customerName:"Consumidor Final",customerPhone:"",customerAddress:"",customerEmail:"",customerCedula:""};const l=String(i.name||"").trim()||(t.customerName&&t.customerName!=="Consumidor Final"?t.customerName:"")||"—";return{...t,documentType:n,documentTypeLabel:A(n),documentTitle:N(n),customerName:l,customerPhone:i.phone||t.customerPhone||"",customerAddress:i.address||t.customerAddress||"",customerEmail:i.email||t.customerEmail||"",customerCedula:i.cedula||t.customerCedula||""}}function ot(t,e){return t==="factura"?"factura":t==="nota_venta"?"nota_venta":e?"documento":"consumidor_final"}function $(t){return`$${g(t).toFixed(2)}`}function H(t){const e=T(t),n=Math.round(e*100)===e*100?2:3;return`$${e.toFixed(n)}`}function U(t){return S(t)}const w={name:"Nom:",cedula:"CI:",phone:"Tel:",address:"Dir:",payment:"Pag:"};function G(t){const e=String(t||"").toLowerCase();return e==="efectivo"?"Efectivo":e==="transferencia"?"Transferencia":e==="tarjeta"?"Tarjeta":e==="credito"?"Crédito":t||"—"}function _(t){if(!t)return null;const e=(t.items||[]).map(r=>({name:r.name||r.productName||"Producto",quantity:Number(r.quantity||0),price:T(r.price),lineTotal:g(r.lineTotal??Number(r.quantity)*Number(r.price)),taxRate:Number(r.taxRate||0),subtotal:g(r.subtotal??r.lineTotal),iva:g(r.iva||0)})),n=g(t.subtotal??e.reduce((r,s)=>r+s.subtotal,0)),i=g(t.iva??e.reduce((r,s)=>r+s.iva,0)),l=g(t.total??e.reduce((r,s)=>r+s.lineTotal,0)),o=t.customer||{},d=t.documentType||"documento",a=j({notes:t.notes||"",customer:o}),c=String(o.name||"").trim()||(a&&a!=="Consumidor Final"?a:""),p=d==="consumidor_final"?"Consumidor Final":c||a||o.name||"—",m=O();return{id:t.id,businessName:m.alias||"App",businessDescription:m.description||"",documentTitle:N(d),documentType:d,documentTypeLabel:A(d),date:U(t.date||t.paidAt),customerName:p,customerPhone:o.phone||"",customerAddress:o.address||"",customerEmail:o.email||"",customerCedula:o.cedula||"",_customerRaw:{name:c,phone:o.phone||"",address:o.address||"",email:o.email||"",cedula:o.cedula||""},paymentMethod:G(t.paymentMethod),items:e,subtotal:n,iva:i,total:l,notes:String(t.notes||"").replace(/\[CAJA_POS\]/g,"").replace(/\[CONTADO\]/g,"").replace(/\[CREDITO\]/g,"").trim()}}function nt(t){if(!t)return null;const n=(t.ERP_order_items||t.items||[]).map(a=>{var h,f;const c=Number(a.quantity||0),p=T(a.price),m=g(c*p),r=Number(((h=a.ERP_inventory_product)==null?void 0:h.taxRate)||a.taxRate||0);let s=m,u=0;return r>0&&(s=g(m/(1+r/100)),u=g(m-s)),{name:((f=a.ERP_inventory_product)==null?void 0:f.name)||a.name||"Producto",quantity:c,price:p,taxRate:r,subtotal:s,iva:u,lineTotal:m}}),i=n.reduce((a,c)=>a+c.subtotal,0),l=n.reduce((a,c)=>a+c.iva,0),o=n.reduce((a,c)=>a+c.lineTotal,0),d=t.ERP_customer||t.customer||{};return _({id:t.id,date:t.date,paidAt:t.paidAt,paymentMethod:t.paymentMethod||"credito",documentType:t.documentType||"nota_venta",notes:t.notes,customer:d,items:n,subtotal:i,iva:l,total:o})}function it({orderId:t,cart:e,customer:n,documentType:i,paymentMethod:l,saleType:o,notes:d}){const a=e.map(s=>{const u=Number(s.quantity||0),h=T(s.price),f=g(u*h),y=Number(s.taxRate||0);let v=f,x=0;return y>0&&(v=g(f/(1+y/100)),x=g(f-v)),{name:s.name,quantity:u,price:h,taxRate:y,subtotal:v,iva:x,lineTotal:f}}),c=a.reduce((s,u)=>s+u.subtotal,0),p=a.reduce((s,u)=>s+u.iva,0),m=a.reduce((s,u)=>s+u.lineTotal,0),r=i;return _({id:t,date:new Date().toISOString(),paidAt:o==="credito"?null:new Date().toISOString(),paymentMethod:o==="credito"?"credito":l,documentType:r,notes:d,customer:n,items:a,subtotal:c,iva:p,total:m})}function at(t,e,n={}){W(J(t,e,n),{format:e})}function J(t,e,n={}){const{showNotes:i=!0}=n,l=L(e),o=l.isTicket,d=l.print,a=l.productColPct,c=o?"100%":"210mm",p=o?d.fs:"14px",m=o?"0":"24px",r=o?"padding:2px 1px;word-wrap:break-word;overflow-wrap:break-word;white-space:normal;vertical-align:top;line-height:1.35;font-weight:600":"padding:2px 0;font-weight:600",s=o?`text-align:center;padding:2px 1px;vertical-align:top;font-size:${d.num}px;font-weight:700`:"text-align:center;padding:2px 4px;font-weight:700",u=o?`text-align:right;padding:2px 1px;vertical-align:top;font-size:${d.num}px;font-weight:700;word-wrap:break-word;overflow-wrap:break-word`:"text-align:right;padding:2px 0;font-weight:700",h=(x,C,R=!1)=>{const k=R?"font-weight:800;":"font-weight:700;",E=R?o?`font-size:${d.totalBold}px;`:"font-size:17px;":"";return`<div style="display:table;width:100%;${k}${E}">
    ...
    ${f}
  </div>`}function b(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}export{tt as D,w as R,Q as a,nt as b,it as c,A as d,G as e,Z as f,H as g,$ as h,X as i,L as j,K as k,z as l,et as m,at as n,U as o,W as p,_ as q,ot as r};
